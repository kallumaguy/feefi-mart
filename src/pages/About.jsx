    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-gray-600'>
          <p className=''>Forever was born out of a passion for innovation and a desire to revolutionize the way
          ...
          <p>Since our inception, we've worked tirelessly to curate a diverse selection of high-quality products
